...
import { EslintPluginSCJs } from "."

import type { Meta, StoryObj } from "@storybook/react"

const meta: Meta<typeof EslintPluginSCJs> = {
  component: EslintPluginSCJs,
}

export default meta
type Story = StoryObj<typeof EslintPluginSCJs>
...
export const IdAndHeadingTextTest: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    const packageNameElement = canvas.getByText("eslint-plugin-sc-js")
    ...
    const ruleElement = canvas.getByText("Rules")
    await expect(ruleElement.parentElement?.getAttribute("id")).toBe("rules")
    await expect(ruleElement.parentElement?.tagName).toBe("H3")
  },
}
