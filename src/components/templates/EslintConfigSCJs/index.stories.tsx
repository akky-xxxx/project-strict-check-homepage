...
import { EslintConfigSCJs } from "."

import type { Meta, StoryObj } from "@storybook/react"

const meta: Meta<typeof EslintConfigSCJs> = {
  component: EslintConfigSCJs,
}

export default meta
type Story = StoryObj<typeof EslintConfigSCJs>
...
export const IdAndHeadingTextTest: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    const packageNameElement = canvas.getByText("eslint-config-sc-js")
