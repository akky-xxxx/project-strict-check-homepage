...
import { EslintConfigSCJest } from "."

import type { Meta, StoryObj } from "@storybook/react"

const meta: Meta<typeof EslintConfigSCJest> = {
  component: EslintConfigSCJest,
}

export default meta
type Story = StoryObj<typeof EslintConfigSCJest>
...
export const IdAndHeadingTextTest: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    const packageNameElement = canvas.getByText("eslint-config-sc-jest")
